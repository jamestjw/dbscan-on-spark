...
/** A rectangle with a left corner of (x, y) and a right upper corner of (x2,
  * y2)
  */
case class DBSCANRectangle(x: Double, y: Double, x2: Double, y2: Double) {
  ...
  /** Returns a whether the rectangle contains the point, and the point is not
    * in the rectangle's border
    */
